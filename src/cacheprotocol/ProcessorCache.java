...
public class ProcessorCache {
     ...
     */
    public ProcessorCache(int cacheLines, int lineSize, int processNumber, int enablePrinting, int noOfProcessors) {
    ...
    private void ProcessWrite(int index, int tag) {
